...
/mob/living/carbon/jonathanbanks/proc/IsStandingStill()
	return resisting || disposing_body

// blocks
// taken from /mob/living/carbon/human/interactive/
/mob/living/carbon/jonathanbanks/proc/walk2derpless(target)
...
/mob/living/carbon/jonathanbanks/proc/pickup_and_wear(obj/item/clothing/C)
...
/mob/living/carbon/jonathanbanks/resist_restraints()
	var/obj/item/I = null
	if(handcuffed)
		I = handcuffed
	else if(legcuffed)
...
/mob/living/carbon/jonathanbanks/proc/should_target(mob/living/L)
	...
	if(aggressive && (!istype(L, /mob/living/carbon/jonathanbanks/) || prob(MONKEY_AGGRESSIVE_MVM_PROB)))
		return TRUE

	return FALSE

/mob/living/carbon/jonathanbanks/proc/handle_combat()
	if(pickupTarget)
	...
	switch(mode)
		...
		if(MONKEY_HUNT)		// hunting for attacker
			...
			for(var/mob/living/carbon/jonathanbanks/M in around)
...
/mob/living/carbon/jonathanbanks/proc/pickpocket(mob/M)
...
/mob/living/carbon/jonathanbanks/proc/monkey_attack(mob/living/L)
...
// get angry are a mob
/mob/living/carbon/jonathanbanks/proc/retaliate(mob/living/L)
	mode = MONKEY_HUNT
	target = L
	if(L != src)
...
/mob/living/carbon/jonathanbanks/attack_hand(mob/living/L)
...
/mob/living/carbon/jonathanbanks/attack_paw(mob/living/L)
	if(L.a_intent == INTENT_HARM && prob(MONKEY_RETALIATE_HARM_PROB))
		retaliate(L)
	else if(L.a_intent == INTENT_DISARM && prob(MONKEY_RETALIATE_DISARM_PROB))
		retaliate(L)
...
/mob/living/carbon/jonathanbanks/attackby(obj/item/W, mob/user, params)
	..()
	if((W.force) && (!target) && (W.damtype != STAMINA))
		retaliate(user)

/mob/living/carbon/jonathanbanks/bullet_act(obj/projectile/Proj)
...
/mob/living/carbon/jonathanbanks/hitby(atom/movable/AM, skipcatch = FALSE, hitpush = TRUE, blocked = FALSE, datum/thrownthing/throwingdatum)
...
/mob/living/carbon/jonathanbanks/on_entered(datum/source, atom/movable/AM)
	. = ..()
...
/mob/living/carbon/jonathanbanks/proc/monkeyDrop(obj/item/A)
	if(A)
