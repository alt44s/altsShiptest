/mob/living/carbon/jonathanbanks/help_shake_act(mob/living/carbon/M)
...
/mob/living/carbon/jonathanbanks/attack_paw(mob/living/M)
	if(..()) //successful jonathan punch.
...
/mob/living/carbon/jonathanbanks/attack_hand(mob/living/carbon/human/M)
...
/mob/living/carbon/jonathanbanks/attack_alien(mob/living/carbon/alien/humanoid/M)
...
/mob/living/carbon/jonathanbanks/attack_animal(mob/living/simple_animal/M)
	. = ..()
	if(.)
		var/damage = rand(M.melee_damage_lower, M.melee_damage_upper)
...
/mob/living/carbon/jonathanbanks/acid_act(acidpwr, acid_volume, bodyzone_hit)
	. = 1
...
/mob/living/carbon/jonathanbanks/ex_act(severity, target, origin)
